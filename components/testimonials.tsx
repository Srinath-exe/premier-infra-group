...
import ClientImg02 from "@/public/images/client-logo-02.png";
import ClientImg03 from "@/public/images/client-logo-03.png";
import ClientImg04 from "@/public/images/client-logo-04.png";
import ClientImg05 from "@/public/images/client-logo-05.png";
import ClientImg06 from "@/public/images/client-logo-06.jpg";
import ClientImg07 from "@/public/images/client-logo-07.png";
import ClientImg08 from "@/public/images/client-logo-08.png";
import ClientImg09 from "@/public/images/client-logo-09.png";
...
export function Testimonial({
  ...
  return (
    ...
    <article 
      className={`relative rounded-2xl bg-white  p-5 backdrop-blur-xs transition-opacity before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-gray-800),var(--color-gray-700),var(--color-gray-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${!testimonial.categories.includes(category) ? "opacity-30" : ""}`}
    
   >
      <div className="flex flex-col gap-4 items-center ">
        <div>
          <Image 
              className="transition-transform duration-300 ease-in-out transform group-hover:scale-150" 
          src={testimonial.clientImg} height={50}   alt="Client logo" />
        </div>
